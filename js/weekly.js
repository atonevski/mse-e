...
vue = new Vue({
  ...
  methods: {
    setDates: function(d) {
      ...
      today = new Date();
      wd = d.getDay();
      this.from = this.daysBefore(d, wd - 1);
      friday = (function() {
        switch (wd) {
          case 0:
          ...
          default:
            return this.daysAfter(d, 5 - wd);
        }
      }).call(this);
      this.to = friday > today ? today : friday;
        ...
        (function(_this) {
          return (function(wd) {
            ...
            p = q.Promise(function(resolve, reject) {
              var url;
              url = wd < D_NEW_FMT ? _this.mseUrl(wd, true) : _this.mseUrl(wd);
